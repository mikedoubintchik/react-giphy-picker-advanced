...
function (_Component) {
  ...
  function _default(props) {
    ...
    _this.state = {
      gifs: [],
      searchValue: '',
      giphySearchUrl: "http://api.giphy.com/v1/gifs/search?api_key=".concat(_this.props.apiKey),
      giphyTrendingUrl: "http://api.giphy.com/v1/gifs/trending?api_key=".concat(_this.props.apiKey)
    };
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(GiphyPickerWrapper, {
      ...
      }, "\xD7"), _react.default.createElement(Input, {
        name: "giphy-search",
        type: "text",
        autoCapitalize: "none",
        autoComplete: "off",
...
var GiphyPickerWrapper = _styledComponents.default.div(_templateObject(), function (props) {
...
var GiphyPicker = _styledComponents.default.div(_templateObject2());
